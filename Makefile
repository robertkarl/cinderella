...
startllama_9b:
	${llama} --model  "${modelcachedir}/${9bq5}" --host localhost --port 8081 --ctx-size 32000 --jinja --flash-attn on --cache-type-k q8_0 --cache-type-v q8_0
